...
export default function Page() {
  ...
  axios.get(`${BACKEND}/api/seller/getSellerDetails`,{
      headers:{
        Authorization:`Bearer ${accessToken}`
      }
  })
  .then((res)=> { setProduct(res.data.products); setseller(res.data.seller);console.log(res.data.seller,res.data.products) })
  .catch((err)=> {if(err.response.data.msg=="Not an Seller"){
  ...
  const deleteproduct=(item:Product)=>{
      ...
      setProduct(filteredproduct)
        ...
        let accessToken=localStorage.getItem("accessToken");
      axios.delete(`${BACKEND}/api/product/deleteProduct?id=${item.id}`,{
      headers:{
        Authorization:`Bearer ${accessToken}`
      }
  })
